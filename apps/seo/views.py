...
class AboutPageView(SEOMixin, TemplateView):
    ...
    seo_title = 'درباره ولتکس'
    seo_description = (
        'ولتکس تولیدکننده و فروشنده اسکوتر برقی پریمیوم است؛ با گارانتی ۳ ساله، '
    ...
    FAQ = [
        (
            'گارانتی اسکوترهای ولتکس چقدر است؟',
            'همه اسکوترهای ولتکس با گارانتی سه‌ساله موتور، کنترلر و باتری عرضه '
        ...
        (
            ...
            'بله. در شوروم ولتکس می‌توانید مدل‌های موجود را از نزدیک ببینید و '
...
class ContactPageView(SEOMixin, TemplateView):
    ...
    seo_title = 'تماس با ولتکس'
    seo_description = (
        'شماره تماس، ایمیل، ساعات کاری و آدرس شوروم ولتکس. برای مشاوره خرید '
